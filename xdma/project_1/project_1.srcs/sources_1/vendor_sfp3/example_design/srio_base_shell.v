...
gtwizard_0_exdes u_gtwizard_0_exdes (
    ...
    .HV_TX_PACKET_IN(HV_TX_PACKET_IN),
    .HV_TX_PACKET_VALID(HV_TX_PACKET_VALID),
    .HV_USE_EXTERNAL_PACKET(HV_USE_EXTERNAL_PACKET),
    ...
    .DBG_HV_RX_PACKET_VALID(DBG_HV_RX_PACKET_VALID),
