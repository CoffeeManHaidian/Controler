...
HD_PWD='D:/Controler/Controler/Controler.runs/loopback_debug_bd_ila_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log loopback_debug_bd_ila_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source loopback_debug_bd_ila_0_0.tcl
