...
HD_PWD='D:/Controler/Controler/Controler.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pcie_cmd_to_optical_hw_bringup_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pcie_cmd_to_optical_hw_bringup_top.tcl
