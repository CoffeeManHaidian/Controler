...
ISEStep( "vivado",
         "-log pcie_cmd_to_optical_hw_bringup_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pcie_cmd_to_optical_hw_bringup_top.tcl -notrace" );
