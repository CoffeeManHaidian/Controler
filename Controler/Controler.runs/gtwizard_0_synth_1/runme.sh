...
HD_PWD='D:/Controler/Controler/Controler.runs/gtwizard_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gtwizard_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gtwizard_0.tcl
